...
export function WorkoutDetailModal({
  ...
  return (
    <div
      className={cn(
        presentation === "modal"
          ? "fixed inset-0 z-50 flex items-center justify-center bg-foreground/20 p-4 backdrop-blur-[2px]"
          : "w-full max-w-3xl",
      )}
    >
      <div className="w-full max-w-3xl rounded-[1.75rem] border border-border bg-surface p-6 shadow-[0_24px_60px_rgba(33,53,45,0.16)] sm:p-8">
